...
## set the data for the plot in numeric format; getting the plotting variable for every single plot. Time and date format is also adjusted
...
## Setting the plot area (ie. Configuration to have four plots, each with the proper format based on the .png models provided)
